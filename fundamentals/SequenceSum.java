...
//
//        sum_of_n (or fundamentals.SequenceSum.sumOfN in Java, fundamentals.SequenceSum.SumOfN in C#) takes an integer n and returns a List
//        (an Array in Java/C#) of length abs(n) + 1. The List/Array contains the numbers in the arithmetic series produced
