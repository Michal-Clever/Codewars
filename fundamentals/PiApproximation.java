...
//
//        There are several ways to determine the precision of the calculus but to keep things easy we will calculate to within epsilon of your language
//        Math::PI constant. In other words we will stop the iterative process when the absolute value of the difference between
//        our calculation and the Math::PI constant of the given language is less than epsilon.
//
//        Your function returns an array or an arryList or a string or a tuple depending on the language
//        (See sample tests) where your approximation of PI has 10 decimals
//
//        In Haskell you can use the function "trunc10Dble" (see "Your solution"); in Clojure you can use the function "round"
//        (see "Your solution");in OCaml or Rust the function "rnd10" (see "Your solution") in order to avoid discusssions about the result.
//
//        Example :
//
...
//        To obtain 100 decimal places of PI,
